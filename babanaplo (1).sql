...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Feb 15. 18:22
...
--
-- Megkötések a táblához `alkalmak`
--
ALTER TABLE `alkalmak`
  ADD CONSTRAINT `alkalmak_ibfk_2` FOREIGN KEY (`BabaId`) REFERENCES `szuletes` (`BabaId`) ON DELETE CASCADE ON UPDATE CASCADE;
